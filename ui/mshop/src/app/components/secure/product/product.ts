...
import { FileService } from '../../../ithouse/services/file.service';
import { Service } from '../../../ithouse/services/service';
import { ProductSellBy } from '../../../ithouse/classes/product-info/product-sell-by';
import { Product as pProduct } from '../../../ithouse/classes/product-info/product';
...
export class Product extends Ithouse implements Service, OnInit {
  ...
  accept: string[];
  uploadFor: string;
  productImage = signal<string[]>([], { equal: _.isEqual });
  index: number = 0;
  isUpdate: boolean = false;
  isHovering: boolean = false;
  userProductInfo = signal([{
    productId: null,
    isActive: 1,
    productName: '',
    productDescription: '',
